            ...
            {grid.map((date) => {
              ...
              return (
                <Link
                  key={key}
                  href={`/day/${key}`}
                  className={`flex min-h-[88px] flex-col gap-0.5 overflow-hidden rounded-none border p-0.5 text-left transition-shadow lg:min-h-[104px] lg:gap-1 lg:rounded-xl lg:p-1.5 ${
                    isToday
